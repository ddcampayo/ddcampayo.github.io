...
//{{{ begin codeInclude
#line 23 "/home/daniel/ddcampayo.github.io/Curso_CFD_OS/cylinder/system/blockMeshDict.#codeStream"
...
extern "C"
{
    void codeStream_d4b53f4df994b98cbf1d3c779ad7e7f6b48afef6
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 28 "/home/daniel/ddcampayo.github.io/Curso_CFD_OS/cylinder/system/blockMeshDict.#codeStream"
pointField points(19); 
        points[0]  = point(0.5, 0, -0.5); 
        points[1]  = point(1, 0, -0.5); 
        points[2]  = point(6, 0, -0.5); 
        points[3]  = point(6, 0.707107, -0.5); 
        points[4]  = point(0.707107, 0.707107, -0.5); 
        points[5]  = point(0.353553, 0.353553, -0.5); 
        points[6]  = point(6, 2, -0.5); 
